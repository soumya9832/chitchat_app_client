...
class RtcAudioManager(context: Context) {
    ...
    private lateinit var appRtcContext: Context
    private lateinit var audioManager: AudioManager


    private var audioManagerEvents: AudioManagerEvents? = null
    private lateinit var amState: AudioManagerState
    ...
    private lateinit var wiredHeadsetReceiver: BroadcastReceiver
    ...
    fun updateAudioDeviceState() {
        ...
        Log.d(
            TAG, ("Device status: " + "available=" + audioDevices + ", " + "selected=" + selectedAudioDevice + ", " + "user selected=" + userSelectedAudioDevice)
        )
        ...
        if (newAudioDevice != selectedAudioDevice || audioDeviceSetUpdated) {
            ...
            Log.d(
                TAG, ("New device status: " + "available=" + audioDevices + ", " + "selected=" + newAudioDevice)
            )
